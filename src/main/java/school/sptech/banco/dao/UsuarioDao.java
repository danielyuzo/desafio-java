...
public class UsuarioDao {
    ...
    public static List<Usuario> listarUsuarios() {
        List<Usuario> usuarios = DatabaseUtils.CONEXOES[1].getConexaoDoBanco().query("""
            SELECT * FROM Usuario
...
//            """, new UsuarioRowMapper());
    ...
    public static List<Usuario> validarLogin(String nome, String senha) {
        List<Usuario> usuarioLogado = DatabaseUtils.CONEXOES[1].getConexaoDoBanco().query("""
